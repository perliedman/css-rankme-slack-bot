...
def print_headshots():
    return format_list('select name, cast(headshots as float) / kills as percentage * 100, cast(headshots as float) / (rounds_tr + rounds_ct) as spr, headshots from rankme order by percentage desc',
