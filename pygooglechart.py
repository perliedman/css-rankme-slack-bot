## CSS RANKME BOT
## Ok I know I'm a bad person, I copied all of this just to fix a single char
## (specifically how the "chco" parameter values are separated), but submitting a
## PR for a deprecated API and waiting for them to make a new release didn't seem
## very effective.
## /perl
